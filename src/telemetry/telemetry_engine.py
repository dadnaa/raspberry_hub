...
class TelemetryEngine:
    ...
    def _process_line(self, line: str) -> None:
        ...
        if prog:
            ...
            if prog.percent > 0:
                # Respect any recent cancel suppress window when deciding
                # to mark the printer as PRINTING. This prevents telemetry
                # from immediately flipping state back to PRINTING after
                # the job has been cancelled and a safe-stop was sent.
